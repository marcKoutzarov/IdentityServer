/*
Deployment script for IdentitySvr.Database
...
GO
:setvar DatabaseName "IdentitySvr.Database"
:setvar DefaultFilePrefix "IdentitySvr.Database"
...
CREATE TABLE [dbo].[ApisScopes] (
    ...
    [UpdatedBy]   NVARCHAR (50) NOT NULL,
    PRIMARY KEY CLUSTERED ([ID] ASC),
    CONSTRAINT [UQ_API_SCOPE] UNIQUE NONCLUSTERED ([ApiID] ASC, [Scope] ASC)
);
...
GO
PRINT N'Creating [dbo].[FK_ClientsScopes_ApiScopes]...';
